...
%   본 파일을 수정하지 않으면 -5점 감점 + 채점 시트 매칭 불가.
    ...
    info.student_id   = '202220878';
    info.name         = '권민수';
    info.team_members = {
        struct('id','202220067', 'name','유정원')
    };   % 2인 팀이면 {struct('id','...','name','...')} 추가
    ...
    info.ai_usage = 'ChatGPT was used to understand the project requirements, identify which files to modify, and get suggestions for controller design and debugging.';
